import { clansActions, directActions, emojiSuggestionActions, notificationActions, settingClanStickerActions } from '@mezon/store';
...
export const clanLoader: CustomLoaderFunction = async ({ params, dispatch }) => {
	...
	dispatch(notificationActions.fetchListNotification(clanId));
