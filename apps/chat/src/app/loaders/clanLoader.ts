import { clansActions, directActions, emojiSuggestionActions, stickerSettingActions } from '@mezon/store';
...
export const clanLoader: CustomLoaderFunction = async ({ params, dispatch }) => {
	...
	dispatch(stickerSettingActions.fetchStickerByClanId({ clanId: clanId, noCache: true }));
