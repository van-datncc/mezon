...
function Homepage() {
	...
	let linkDownload = 'https://cdn.mezon.vn/release/mezon-1.1.60-beta.2-win-x64.exe';
	if (navigator.userAgent.includes('Mac')) {
		linkDownload = 'https://cdn.mezon.vn/release/Mezon-1.1.60-beta.2-arm64-mac.zip';
	} else if (navigator.userAgent.includes('Linux')) {
		linkDownload = 'https://cdn.mezon.vn/release/mezon-1.1.60-beta.2-linux-amd64.deb';
	}
