...
import { directActions, DirectEntity, selectDirectById, useAppDispatch } from '@mezon/store';
					...
					<NavLinkComponent clanName={directMessage.channel_label || ''}>
						<div>
							<AvatarImage 
								...
								src={directMessage.type === ChannelType.CHANNEL_TYPE_DM ? directMessage.channel_avatar?.at(0) : 'assets/images/avatar-group.png'}
							/>
