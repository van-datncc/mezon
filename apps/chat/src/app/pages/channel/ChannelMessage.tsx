...
export function ChannelMessage(props: MessageProps) {
	...
	return (
		<div className="relative group">
			...
			<div className="absolute top-[-15px] p-0.5 rounded-md right-4 w-24 flex flex-row bg-black opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-hover:bg-slate-800">
				<button className="h-full p-1 group">
					<Icons.Smile />
				</button>
			</div>
		</div>
