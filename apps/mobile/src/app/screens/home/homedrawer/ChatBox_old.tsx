...
import { DeviceEventEmitter, Dimensions, Keyboard, KeyboardEvent, Platform, TextInput, TouchableOpacity, View } from 'react-native';
import { TriggersConfig, useMentions } from 'react-native-controlled-mentions';
import RNFS from 'react-native-fs';
import Toast from 'react-native-toast-message';
import { useSelector } from 'react-redux';
import { useThrottledCallback } from 'use-debounce';
import { ChannelsMention, EmojiSuggestion } from '../../../components/Suggestions';
...
const ChatBox_old = memo((props: IChatBoxProps) => {
