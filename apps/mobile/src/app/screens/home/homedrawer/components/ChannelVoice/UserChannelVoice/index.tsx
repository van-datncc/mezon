...
import { style } from './UserChannelVoice.styles';
import UserItem from './UserItem';
const MAX_VISIBLE_USERS = 5;
function UserChannelVoice({ streamChannelMember }: { streamChannelMember: UsersStreamEntity[] }) {
...
export default React.memo(UserChannelVoice);
