...
>
    <View style={s.wrapperCreateClanModal}>
      ...
      <TouchableOpacity  style={s.uploadImage} onPress={onOpen}>
        {
          !urlImage ? <View style={[s.uploadCreateClan]}>
          ...
          </View> :  <View style={[s.uploadCreateClan, s.overflowImage]}>
          <Image source={{ uri: urlImage }} style={s.image} /></View>
        }
      </TouchableOpacity>
      </View>
      ...
      <MezonButton disabled={!nameClan} viewContainerStyle={s.button} onPress={handleCreateClan} ><Text style={s.buttonText}>{t('createServer')}</Text></MezonButton>
    </View>
</MezonModal>
  )
}
