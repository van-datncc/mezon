...
export const SetupPermissions = ({ navigation, route }: MenuClanScreenProps<SetupPermissionsScreen>) => {
    ...
    navigation.setOptions({
        headerTitle: !isEditRoleMode ? t('setupPermission.title') : () => {
            return (
                <Block>
    ...
    return (
        ...
        >
            <Block flex={1}>
                ...
                >
                    <Text color={themeValue.white} h2 center bold>{t('setupPermission.setupPermissionTitle')}</Text>
                </Block>
                                ...
                                return (
                                    <TouchableOpacity onPress={() => onSelectPermissionChange(!selectedPermissions.includes(item?.id), item?.id)}>
                                        ...
                                        >
                                            ...
                                            <MezonSwitch value={selectedPermissions.includes(item?.id)} onValueChange={(isSelect) => onSelectPermissionChange(isSelect, item?.id)} />
                                        </Block>
                                    </TouchableOpacity>
                                )
                            }}
            ...
            {!isEditRoleMode ? (
                <Block marginBottom={size.s_16} gap={size.s_10}>
                    <TouchableOpacity onPress={() => handleNextStep()}>
                        ...
                        >
                            <Text center color={Colors.white}>{t('setupPermission.next')}</Text>
                        </Block>
                    </TouchableOpacity>
