    ...
    return (
        ...
        >
            <Block paddingVertical={size.s_14}>
                <Text center color={themeValue.text}>{t('roleDescription')}</Text>
            </Block>
            ...
            <TouchableOpacity onPress={() => navigateToRoleEveryone()}>
                ...
                >
                    <Block flexDirection="row" flex={1}>
                        <Block
                        ...
                        <Block flex={1}>
                            ...
                            <Text color={themeValue.text} numberOfLines={1}>{t('defaultRole')}</Text>
                        </Block>
                    </Block>
            ...
            <Block marginTop={size.s_10} flex={1}>
                <Text color={themeValue.text}>{t('roles')} - {RolesClan?.length || '0'}</Text>
                {RolesClan.length ? (
                                        ...
                                        <TouchableOpacity onPress={() => navigateToRoleDetail(item)}>
                                            ...
                                            >
                                                ...
                                                <Block flex={1}>
                                                    ...
                                                    <Text color={themeValue.text}>{item?.role_user_list?.role_users?.length || '0'} - {t('members')}</Text>
                                                </Block>
                                                <Icons.ChevronSmallRightIcon color={themeValue.text}/>
                                            </Block>
                                        </TouchableOpacity>
                    ...
                    <Block marginTop={size.s_20}>
                        <Text color={themeValue.text} center>{t('noRole')}</Text>
                    </Block>
                )}
            </Block>
        </Block>
