...
const Header = () => {
    ...
    return (
        <div className={`fixed z-10 w-full px-[42px] py-[12px] flex flex-row items-center justify-between border-b-[1px] border-solid ${isDarkMode ? 'dark:border-borderDividerLight' : 'border-bgModifierHoverLight'}`}>
            <div className="flex flex-row items-center justify-center gap-[4px]">
                <Image src={`${isDarkMode ? 'assets/images/mezon-logo-black.svg' : 'assets/images/mezon-logo-white.svg'}`} alt={'logoMezon'} width={28} height={28} />
