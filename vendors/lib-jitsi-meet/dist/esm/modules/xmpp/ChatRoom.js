...
export default class ChatRoom extends Listenable {
    ...
    discoRoomInfo() {
        ...
        this.connection.sendIQ(getInfo, result => {
            ...
            const meetingCreatedTSValEl = $(result).find('>query>x[type="result"]>field[var="muc#roominfo_created_timestamp"]>value');
    ...
    onMessage(msg, from) {
        ...
        if (txt) {
            if (type === 'chat') {
                ...
                this.eventEmitter.emit(XMPPEvents.MESSAGE_RECEIVED, from, txt, this.myroomjid, stamp, nick, Boolean(nick));
            }
        }
    }
    /**
    ...
    onPresenceError(pres, from) {
        ...
        if ($(pres)
            ...
            this.eventEmitter.emit(XMPPEvents.DISPLAY_NAME_REQUIRED, (_a = errorDescriptionNode[0].attributes.lobby) === null || _a === void 0 ? void 0 : _a.value);
        }
        else {
            logger.warn('onPresError ', pres);
