...
export default class JingleSessionPC extends JingleSession {
    ...
    doInitialize(options) {
        ...
        if (!this.isP2P) {
            ...
            pcOptions.capScreenshareBitrate = !(((_a = options.desktopSharingFrameRate) === null || _a === void 0 ? void 0 : _a.max) > SS_DEFAULT_FRAME_RATE);
        }
    ...
    addTracks(localTracks = null) {
        if (!(localTracks === null || localTracks === void 0 ? void 0 : localTracks.length)) {
