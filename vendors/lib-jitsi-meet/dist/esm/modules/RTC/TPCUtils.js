...
import { SIM_LAYERS, STANDARD_CODEC_SETTINGS, VIDEO_QUALITY_LEVELS, VIDEO_QUALITY_SETTINGS } from '../../service/RTC/StandardVideoSettings';
...
export class TPCUtils {
    ...
    constructor(peerconnection) {
        ...
        const videoQualitySettings = (_a = this.pc.options) === null || _a === void 0 ? void 0 : _a.videoQuality;
        if (videoQualitySettings) {
            for (const codec of VIDEO_CODECS) {
                const codecConfig = videoQualitySettings[codec];
                const bitrateSettings = (_b = codecConfig === null || codecConfig === void 0 ? void 0 : codecConfig.maxBitratesVideo) !== null && _b !== void 0 ? _b : (videoQualitySettings.maxbitratesvideo
    ...
    _calculateActiveEncodingParams(localVideoTrack, codec, newHeight) {
        ...
        const desktopShareBitrate = ((_b = (_a = this.pc.options) === null || _a === void 0 ? void 0 : _a.videoQuality) === null || _b === void 0 ? void 0 : _b.desktopbitrate) || codecBitrates.ssHigh;
            ...
            if (newHeight > 0) {
                if (localVideoTrack.getVideoType() === VideoType.CAMERA) {
                    active = frameHeight <= newHeight
                        ...
                        // simulcast streams.
                        || ((_a = videoStreamEncodings[idx]) === null || _a === void 0 ? void 0 : _a.scaleResolutionDownBy) === SIM_LAYERS[0].scaleFactor;
                }
                else {
