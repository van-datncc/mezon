...
class FeatureFlags {
    ...
    init(flags) {
        ...
        this._ssrcRewriting = (_a = flags.ssrcRewritingEnabled) !== null && _a !== void 0 ? _a : true;
        this._joinAsVisitor = Boolean((_b = flags.enableJoinAsVisitor) !== null && _b !== void 0 ? _b : true);
    }
    /**
