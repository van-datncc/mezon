	...
	return (
		<Svg width={width} height={height} viewBox="0 0 36 50" fill="none" {...props}>
			<Path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M31.25 22.5C31.25 30 24.9 35.25 18 35.25C11.1 35.25 4.75 30 4.75 22.5H0.5C0.5 31.025 7.3 38.075 15.5 39.3V50H20.5V39.3C28.7 38.1 35.5 31.05 35.5 22.5H31.25Z"
				fill="#c7c7c7"
			/>
			<Path
				d="M25.475 22.5C25.475 26.65 22.15 30 18 30C13.85 30 10.5 26.65 10.5 22.5V7.5C10.5 3.35 13.85 0 18 0C22.15 0 25.5 3.35 25.5 7.5L25.475 22.5Z"
				fill="#c7c7c7"
			/>
		</Svg>
	);
...
export function SendIcon({ width = 60, height = 60, ...props }: SvgProps) {
	return (
		<Svg width={width} height={height} viewBox="0 0 60 60" fill="none" {...props}>
			<Path
				d="M31.0268 32.3299L7.49989 34.6045L1.30886 54.4046C0.939715 55.5753 1.30183 56.8548 2.23343 57.6566C3.16151 58.458 4.4799 58.6267 5.58386 58.089L57.144 33.1211C58.1531 32.6289 58.7929 31.6058 58.7929 30.4843C58.7929 29.3629 58.1528 28.3398 57.144 27.8476L5.61896 2.86181C4.51504 2.32392 3.1967 2.49267 2.26853 3.29424C1.33685 4.09581 0.974778 5.37198 1.34396 6.54269L7.53495 26.3427L31.016 28.6208C31.9652 28.7157 32.6894 29.5138 32.6894 30.4665C32.6894 31.4193 31.9652 32.2173 31.016 32.3122L31.0268 32.3299Z"
				fill="white"
			/>
		</Svg>
	);
