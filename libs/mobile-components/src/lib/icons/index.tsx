...
export function CopyIcon({ width = 20, height = 20, color = 'white', ...props }: SvgProps) {
	return (
		<Svg viewBox="0 0 32 33" width={width} height={height} fill="none" {...props}>
			...
			/>
			<Path
				d="M28.973 16a3.996 3.996 0 00-.8-1.173l-5.666-5.654a4 4 0 00-1.174-.813V12a4 4 0 004 4h3.64z"
				fill={color}
			/>
		</Svg>
	);
...
export function LinkIcon({ width = 20, height = 20, color = 'white', ...props }: SvgProps) {
	return (
		...
		>
			...
			/>
			<Path
				d="M19.6 14.267a1.334 1.334 0 10-1.867-1.867L12.4 17.733a1.333 1.333 0 001.867 1.867l5.333-5.333z"
				fill={color}
			/>
		</Svg>
	);
