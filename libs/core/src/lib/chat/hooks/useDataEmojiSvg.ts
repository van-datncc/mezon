...
function useDataEmojiSvg() {
	const emojiListPNG = [
		...
		{ src: rugby_football, shortname: ':rugby_football:', category: 'Activities' },
		...
		{ src: checkered_flag, shortname: ':checkered_flag:', category: 'Flags' },
		...
		{ src: transgender_flag, shortname: ':transgender_flag:', category: 'Flags' },
		{ src: triangular_flag_on_post, shortname: ':triangular_flag_on_post:', category: 'Flags' },
		{ src: united_nations, shortname: ':united_nations:', category: 'Flags' },
		{ src: apple, shortname: ':apple:', category: 'Food' },
		{ src: banana, shortname: ':banana:', category: 'Food' },
		{ src: blueberries, shortname: ':blueberries:', category: 'Food' },
		...
		{ src: green_apple, shortname: ':green_apple:', category: 'Food' },
		...
		{ src: see_no_evil, shortname: ':see_no_evil:', category: 'Nature' },
		...
		{ src: camera_with_flash, shortname: ':camera_with_flash:', category: 'Objects' },
		...
		{ src: floppy_disk, shortname: ':floppy_disk:', category: 'Objects' },
		...
		{ src: mouse_three_button, shortname: ':mouse_three_button:', category: 'Objects' },
		...
		{ src: face_holding_back_tears, shortname: ':face_holding_back_tears:', category: 'People' },
		...
		{ src: slight_smile, shortname: ':slight_smile:', category: 'People' },
		{ src: smile, shortname: ':smile:', category: 'People' },
		{ src: smiley, shortname: ':smiley:', category: 'People' },
		{ src: smiling_face_with_tear, shortname: ':smiling_face_with_tear:', category: 'People' },
		...
		{ src: heart_exclamation, shortname: ':heart_exclamation:', category: 'Symbols' },
		{ src: heartbeat, shortname: ':heartbeat:', category: 'Symbols' },
		{ src: heartpulse, shortname: ':heartpulse:', category: 'Symbols' },
		{ src: light_blue_heart, shortname: ':light_blue_heart:', category: 'Symbols' },
		{ src: orange_heart, shortname: ':orange_heart:', category: 'Symbols' },
		{ src: pink_heart, shortname: ':pink_heart:', category: 'Symbols' },
		{ src: purple_heart, shortname: ':purple_heart:', category: 'Symbols' },
		{ src: revolving_hearts, shortname: ':revolving_hearts:', category: 'Symbols' },
		...
		{ src: articulated_lorry, shortname: ':articulated_lorry:', category: 'Travel' },
		...
		{ src: fire_engine, shortname: ':fire_engine:', category: 'Travel' },
		{ src: minibus, shortname: ':minibus:', category: 'Travel' },
		{ src: manual_wheelchair, shortname: ':manual_wheelchair:', category: 'Travel' },
		{ src: motorized_wheelchair, shortname: ':motorized_wheelchair:', category: 'Travel' },
