...
export function CopyLink(props: React.HTMLAttributes<SVGElement>) {
	return (
		<svg fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="" {...props}>
			<g strokeWidth="0"></g>
...
// export function Spinner(props: React.HTMLAttributes<SVGElement>) {
// 	return (
// 		<svg
// 			aria-hidden="true"
