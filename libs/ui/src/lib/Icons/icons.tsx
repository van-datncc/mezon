...
export const MutePTT: React.FC<IconProps> = ({ isWhite }) => {
	return (
		<svg
			...
			width="32"
			height="32"
			className={`dark:hover:text-white hover:text-black ${isWhite ? 'dark:text-white text-black' : 'text-theme-primary'}`}
			viewBox="0 -4 24 24"
		>
...
export const ThreeDot: React.FC<IconProps> = ({ defaultFill = '#AEAEAE', defaultSize = 'w-5 h-5', className }) => {
	return (
		<svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={` text-theme-primary ${className}  ${defaultSize}`}>
			<g id="Live area">
				<g id="Vector">
					<path
