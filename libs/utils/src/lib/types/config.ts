...
export const SUPPORTED_PHOTO_CONTENT_TYPES = new Set(['image/png', 'image/jpeg', GIF_MIME_TYPE]);
...
export const CONTENT_TYPES_WITH_PREVIEW = new Set([...SUPPORTED_PHOTO_CONTENT_TYPES, ...SUPPORTED_VIDEO_CONTENT_TYPES]);
...
export const DEFAULT_LIMITS: Record<any, readonly [number, number]> = {
