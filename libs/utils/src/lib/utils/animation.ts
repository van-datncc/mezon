...
export function animateSingle(tick: AnyFunction, schedulerFn: Scheduler, instance?: AnimationInstance) {
	if (!instance) {
...
export function animate(tick: AnyFunction, schedulerFn: Scheduler) {
	schedulerFn(() => {
		if (tick()) {
...
export function animateInstantly(tick: AnyFunction, schedulerFn: Scheduler) {
	if (tick()) {
		schedulerFn(() => {
