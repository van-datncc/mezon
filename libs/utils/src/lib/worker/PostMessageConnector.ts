...
import { throttleWithTickEnd } from '../utils';
...
export type OriginPayload = InitPayload | CallMethodPayload | CancelProgressPayload;
...
export function createConnector<T extends InputRequestTypes>(worker: Worker, onUpdate?: (update: ApiUpdate) => void, channel?: string) {
