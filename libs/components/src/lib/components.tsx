...
export { default as MessageContent, TopicViewButton } from './components/MessageWithUser/MessageContent';
...
export { default as RemoveFriendModal } from './components/RemoveFriendModal';
