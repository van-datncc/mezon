		...
		<div className="w-[700px] fixed bottom-[20px] left-[50%] translate-x-[-50%] py-[10px] pl-4 pr-[10px] rounded-[5px] bg-bgProfileBody">
			<div className="flex flex-row justify-between items-center">
				...
				<div className="flex flex-row justify-end gap-[10px]">
					<Button
						onClick={onReset}
						className="h-10 w-fit rounded bg-transparent border border-buttonProfile hover:!bg-buttonProfileHover dark:bg-transparent dark:hover:!bg-buttonProfile focus:!ring-transparent"
					>
						Reset
					</Button>
					<Button
