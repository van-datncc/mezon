			...
			{!openEdit && (
				<>
					...
					<div className="flex items-center space-x-4 ">
						...
						<ButtonLoading
							className="text-[15px] bg-button-primary hover:opacity-80 rounded-lg text-white py-[5px] px-2 text-nowrap font-medium inline-flex items-center justify-center h-[32.5px]"
