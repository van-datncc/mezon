				...
				<>
					...
					<div className={`overflow-hidden w-full ${appearanceTheme === 'light' ? 'customScrollLightMode' : ''}`}>
						<table className="w-full divide-y divide-gray-200 dark:divide-gray-500">
							<thead>
								<tr className="h-11">
									<th scope="col" className="text-xs font-bold dark:text-textSecondary text-textSecondary800 uppercase tracking-wider w-1/2 text-left">
										Roles - {rolesClan.length}
									</th>
									<th scope="col" className="text-xs font-bold dark:text-textSecondary text-textSecondary800 uppercase tracking-wider w-1/4 text-center">
										Members
									</th>
									<th scope="col" className="text-xs font-bold dark:text-textSecondary text-textSecondary800 uppercase tracking-wider w-1/4 text-center">
									</th>
								...
								{activeRoles.length === 0 ? (
									<tr className="h-14">
										<td className="dark:text-gray-300 text-gray-600 text-[15px]">
											<p className='inline-flex gap-x-2 mt-1.5'><Icons.RoleIcon defaultSize="w-5 h-5 min-w-5" />No Roles</p>
										</td>
									</tr>
								) : (
									<ListActiveRole 
