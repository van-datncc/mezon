	...
	return (
		<>
			<div className="w-full flex justify-between mb-5">
				<button
					className={`p-[5px] text-white  text-left transition duration-300 hover:bg-slate-800 rounded relative tracking-wider ${selectedButton === 'Display' ? 'shadow-md' : ''}`}
					onClick={() => {
				...
				<button
					className={`p-[5px] text-white  text-left transition duration-300 hover:bg-slate-800 rounded relative tracking-wider ${selectedButton === 'Permissions' ? 'shadow-md' : ''}`}
					onClick={() => {
				...
				<button
					className={`p-[5px] text-white text-left transition duration-300 hover:bg-slate-800 rounded relative tracking-wider ${selectedButton === 'Manage Members' ? 'shadow-md' : ''}`}
					onClick={() => {
