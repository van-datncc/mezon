			...
			<div className="flex flex-col gap-4">
				...
				<div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
					...
					{soundList.map((sound) => (
						<div
							key={sound.id}
							className="flex flex-col w-full p-4 border rounded-lg bg-white dark:bg-bgSecondary shadow-sm hover:shadow-md transition duration-200 dark:border-borderDivider border-gray-200"
						>
