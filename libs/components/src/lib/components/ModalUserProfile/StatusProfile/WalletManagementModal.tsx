...
const WalletManagementModal: React.FC<WalletManagementModalProps> = ({ isOpen, onClose }) => {
	...
	return (
		<div className="thread-scroll fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
			<div className="dark:bg-bgPrimary bg-bgLightMode rounded-lg shadow-xl max-w-lg w-full mx-4 p-6 max-h-[80vh] overflow-y-auto">
