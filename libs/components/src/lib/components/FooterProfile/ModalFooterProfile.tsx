...
const ModalFooterProfile = ({ userId, avatar, name, isDM, userStatusProfile, rootRef }: ModalFooterProfileProps) => {
	...
	return (
		<div
			...
			className={`outline-none fixed sbm:left-[50px] left-5 bottom-[70px] dark:bg-black bg-gray-200 mt-[10px] w-[340px] max-w-[89vw] rounded-lg flex flex-col z-20 opacity-100 shadow-md shadow-bgTertiary-500/40 origin-bottom animate-scale_up`}
		>
