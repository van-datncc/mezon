	...
	return (
		<div className=" overflow-y-auto w-1/6 xl:w-1/4 min-w-56 bg-black flex justify-end pt-96 pr-2 scrollbar-thin scrollbar-thumb-black scrollbar-track-gray-200 2xl:flex-grow hide-scrollbar flex-grow">
			<div className="w-170px ">
				...
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
					Privacy & Safety
				</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
				...
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">Devices</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
					Connections
				</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">Clips</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] mb-[10px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
					Friend Requests
				</button>
				...
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-4 ml-[-8px] hover:text-white">
					Appearance
				</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
				...
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">Keybinds</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">Language</button>
				<br />
				<button className="p-2 text-[#AEAEAE] text-[15px] w-[170px] rounded-[5px] text-left mt-1 ml-[-8px] hover:text-white">
					Streamer Mode
				</button>
