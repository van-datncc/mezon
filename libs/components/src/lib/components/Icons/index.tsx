  ...
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"  {...props}>
      <g clip-path="url(#clip0_2719_1783)">
        <path d="M10 2.34375C10.3238 2.34375 10.5859 2.0816 10.5859 1.75781V0.585938C10.5859 0.262146 10.3238 0 10 0C9.67621 0 9.41406 0.262146 9.41406 0.585938V1.75781C9.41406 2.0816 9.67621 2.34375 10 2.34375Z" fill="white" />
        <path d="M12.758 3.34396L13.9299 2.17209C14.1588 1.94321 14.1588 1.57242 13.9299 1.34354C13.701 1.11465 13.3302 1.11465 13.1013 1.34354L11.9295 2.51541C11.7006 2.74429 11.7006 3.11508 11.9295 3.34396C12.1584 3.57285 12.5291 3.57285 12.758 3.34396Z" fill="white" />
        <path d="M7.24197 3.34396C7.47086 3.57285 7.84164 3.57285 8.07053 3.34396C8.29941 3.11508 8.29941 2.74429 8.07053 2.51541L6.89865 1.34354C6.66977 1.11465 6.29898 1.11465 6.0701 1.34354C5.84122 1.57242 5.84122 1.94321 6.0701 2.17209L7.24197 3.34396Z" fill="white" />
        <path d="M5.27344 8.28125C5.27344 6.98868 4.22226 5.9375 2.92969 5.9375C1.63712 5.9375 0.585938 6.98868 0.585938 8.28125C0.585938 9.57382 1.63712 10.625 2.92969 10.625C4.22226 10.625 5.27344 9.57382 5.27344 8.28125Z" fill="white" />
        <path d="M10 4.72656C9.03076 4.72656 8.24219 5.51514 8.24219 6.48438C8.24219 8.74573 6.36292 10.625 4.10156 10.625H2.92969C1.31439 10.625 0 11.9394 0 13.5547V19.4141C0 19.7379 0.262146 20 0.585938 20H5.27344C5.59677 20 5.85159 19.7379 5.85159 19.4147L5.85495 13.9352C9.27673 13.129 11.7578 10.0481 11.7578 6.48438C11.7578 5.51514 10.9692 4.72656 10 4.72656Z" fill="white" />
        <path d="M19.4141 8.28125C19.4141 6.98868 18.3629 5.9375 17.0703 5.9375C15.7777 5.9375 14.7266 6.98868 14.7266 8.28125C14.7266 9.57382 15.7777 10.625 17.0703 10.625C18.3629 10.625 19.4141 9.57382 19.4141 8.28125Z" fill="white" />
        <path d="M17.0703 10.625H15.8984C14.5511 10.625 13.3246 9.92419 12.5764 8.91772C12.2336 10.1274 11.6363 11.2253 10.8387 12.1654C11.773 12.9901 12.9275 13.6447 14.1449 13.9347L14.1484 19.4147C14.1484 19.7379 14.4032 20 14.7265 20H19.414C19.7378 20 20 19.7379 20 19.4141V13.5547C20 11.9394 18.6856 10.625 17.0703 10.625Z" fill="white" />
      </g>
      <defs>
...
export const BrowwseChannel: React.FC<IconProps> = ({
  defaultSize = 'w-5 h-5',
}) => {
  return (
    <svg
...
export const LongCorner: React.FC<IconProps> = ({
  defaultSize = 'w-5 h-5',
}) => {
  return (
    <svg
...
export const ShortCorner: React.FC<IconProps> = ({
  defaultSize = 'w-5 h-5',
}) => {
  return (
    <svg
...
export const Forum: React.FC<IconProps> = ({
  defaultFill = '#AEAEAE',
  defaultSize = 'w-5 h-5',
}) => {
  return (
...
export const Announcement: React.FC<IconProps> = ({
  defaultFill = '#AEAEAE',
  defaultSize = 'w-5 h-5',
}) => {
  return (
