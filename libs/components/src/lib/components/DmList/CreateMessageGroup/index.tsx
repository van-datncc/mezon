...
const CreateMessageGroup = ({ onClose, classNames, currentDM, rootRef }: CreateMessageGroupProps) => {
	...
	return (
		<div
			...
			className={`outline-none dark:bg-bgPrimary bg-bgLightPrimary z-10 w-[440px] border border-slate-300 dark:border-none rounded shadow shadow-neutral-800 ${classNames}`}
			onClick={(e) => {
				e.stopPropagation();
			}}
		>
