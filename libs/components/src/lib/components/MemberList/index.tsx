	...
	return (
		<div className="self-stretch h-[268px] flex-col justify-start items-start flex p-4 gap-[24px] w-full">
			<div className="w-full">
				<p className="mb-3 text-[#AEAEAE] text-[14px] font-semibold flex items-center gap-[4px] font-title text-xs tracking-wide uppercase">
				...
				{offlineMembers.length > 0 && (
					<>
						<p className="mt-7 mb-3 text-[#AEAEAE] text-[14px] font-semibold flex items-center gap-[4px] font-title text-xs tracking-wide uppercase">
