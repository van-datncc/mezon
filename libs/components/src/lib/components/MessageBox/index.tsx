...
function MessageBox(props: MessageBoxProps): ReactElement {
  ...
  return (
    <div className="relative max-sm:-pb-2  ">
      ...
      <div
        className={`flex flex-inline items-start gap-2 box-content mb-4 max-sm:mb-0 max-h-50vh overflow-hidden overflow-y-auto
      ...
      >
        ...
        <div className={`w-20 h-auto flex sticky top-[10px] right-2`}>
