...
const getChannelFavorite = ({ listIdChannelFavor, listChannelClan }: { listIdChannelFavor: string[], listChannelClan: ChannelsEntity[] }) => {

  return listChannelClan.filter((channel) => listIdChannelFavor.includes(channel.id));
}
