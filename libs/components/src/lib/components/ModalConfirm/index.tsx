...
const ModalConfirm = ({ handleCancel, title = "Title Modal", buttonName = "OK", modalName, handleConfirm, buttonColor, message = `You won’t be able to re-join this
            server unless you are re-invited.`, customModalName }: ModalConfirmProps) => {
