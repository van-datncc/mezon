...
const DeleteClanModal: React.FC<DeleteClanModalProps> = ({ onClose }) => {
	return (
		<div className="fixed inset-0 flex items-center justify-center z-50 ">
			...
			<div className="relative z-10 dark:bg-[#313338] bg-bgLightModeSecond rounded-[5px]">
				<div className="top-block p-[16px] dark:text-textDarkTheme text-textLightTheme flex flex-col gap-[15px]">
					<div className="text-xl font-semibold">Delete clan</div>
					...
					<div className="mb-[15px]">
						...
						<input
							type="text"
							className="w-full dark:bg-[#1e1f22] bg-[#dddcdc] dark:text-textDarkTheme text-textLightTheme rounded-[5px] outline-none p-[10px]"
						/>
					</div>
				</div>
				<div className="bottom-block flex justify-end p-[16px] dark:bg-[#2b2d31] bg-[#e1dfdf] items-center gap-[20px] font-semibold rounded-[5px]">
					...
					<div className="bg-[#da373c] hover:bg-[#a12828] rounded-md px-4 py-2 cursor-pointer">Delete clan</div>
				</div>
			</div>
		</div>
	);
