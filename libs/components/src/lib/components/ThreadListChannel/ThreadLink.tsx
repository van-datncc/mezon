	...
	return (
		<div className="flex flex-row items-center h-[34px] relative ">
			...
			<Link
				...
				className={`${classes[state]} ml-5 w-full leading-[24px] rounded font-medium hover:text-white text-[15px] ${active ? 'font-medium bg-bgModifierHover text-white' : ''} ${isUnReadChannel ? 'font-bold text-white' : ''}`}
				ref={panelRef}
