	...
	return (
		<div className="flex flex-row items-center h-[34px] relative ">
			...
			<Link
				...
				className={`${classes[state]} ml-5 w-full leading-[24px] rounded font-medium hover:text-white text-[15px] max-w-full overflow-x-hidden whitespace-nowrap ${active ? 'font-medium bg-[#36373D] text-white' : ''} ${isUnReadChannel ? 'font-bold text-white' : ''}`}
				ref={panelRef}
