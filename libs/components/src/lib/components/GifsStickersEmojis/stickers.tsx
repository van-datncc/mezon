...
function ImageSquare({ channelId, channelLabel, mode }: ChannelMessageBoxProps) {
	...
	const images = [
		{ id: 1, url: 'https://cdn.mezon.vn/sticker/CrocosaurusStickers/emojibest_com_crocosaurus_0.gif', type: 'cs' },
		{ id: 2, url: 'https://cdn.mezon.vn/sticker/CrocosaurusStickers/emojibest_com_crocosaurus_4.gif', type: 'cs' },
		{ id: 3, url: 'https://cdn.mezon.vn/sticker/CrocosaurusStickers/emojibest_com_crocosaurus_18.gif', type: 'cs' },
		{ id: 4, url: 'https://cdn.mezon.vn/sticker/FredTheDog/emojibest_com_fred_the_pug_0.gif', type: 'cs' },
		{ id: 5, url: 'https://cdn.mezon.vn/sticker/FredTheDog/emojibest_com_fred_the_pug_1.gif', type: 'cs' },
		{ id: 6, url: 'https://cdn.mezon.vn/sticker/FredTheDog/emojibest_com_fred_the_pug_11.gif', type: 'dog' },
		{ id: 7, url: 'https://cdn.mezon.vn/sticker/MemesWithCats/emojibest_com_memes_with_cats_7.gif', type: 'dog' },
		{ id: 8, url: 'https://cdn.mezon.vn/sticker/MemesWithCats/emojibest_com_memes_with_cats_11.gif', type: 'dog' },
		{ id: 9, url: 'https://cdn.mezon.vn/sticker/MemesWithCats/emojibest_com_memes_with_cats_17.gif', type: 'dog' },
		{ id: 10, url: 'https://cdn.mezon.vn/sticker/SamuraiDojo/emojibest_com_samorai__dojo_0.gif', type: 'dog' },
		{ id: 11, url: 'https://cdn.mezon.vn/sticker/SamuraiDojo/emojibest_com_samorai__dojo_7.gif', type: 'cat' },
		{ id: 12, url: 'https://cdn.mezon.vn/sticker/SamuraiDojo/emojibest_com_samorai__dojo_8.gif', type: 'cat' },
		{ id: 13, url: 'https://cdn.mezon.vn/sticker/EmojiDom/emojibest_com_emojidom_anim_5.gif', type: 'cat' },
