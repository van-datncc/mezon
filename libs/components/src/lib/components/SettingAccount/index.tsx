...
const SettingAccount = ({onSettingProfile}: SettingAccountProps) => {
	...
	return (
		<div className="overflow-y-auto flex flex-col flex-1 shrink dark:bg-bgPrimary bg-white w-1/2 pt-[94px] pb-7 pr-[10px] pl-[40px] overflow-x-hidden min-w-[700px] 2xl:min-w-[900px] max-w-[740px] hide-scrollbar dark:text-white text-colorTextLightMode text-sm">
			...
			<div className="w-full rounded-lg overflow-hidden dark:bg-black bg-bgLightMode">
				...
				<div className="flex justify-between relative -top-5 px-4 items-center">
					...
					<div className="bg-primary h-fit px-4 py-2 rounded cursor-pointer hover:bg-opacity-80 text-white" onClick={handleClick}>Edit User Profile</div>
				</div>
