...
const SettingAccount = ({onSettingProfile, menuIsOpen}: SettingAccountProps) => {
	...
	return (
		<div className={`"overflow-y-auto flex flex-col flex-1 shrink dark:bg-bgPrimary bg-white w-1/2 pt-[94px] pb-7 pr-[10px] sbm:pl-[40px] pl-[10px] overflow-x-hidden ${menuIsOpen === true ? "min-w-[700px]" : ""} 2xl:min-w-[900px] max-w-[740px] hide-scrollbar dark:text-white text-colorTextLightMode text-sm"`}>
