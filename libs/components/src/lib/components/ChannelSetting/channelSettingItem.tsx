	...
	return (
		<div className=" overflow-y-auto w-1/6 xl:w-1/4 min-w-56 bg-bgSecondary flex justify-end pt-96 pr-2 scrollbar-thin scrollbar-thumb-black scrollbar-track-gray-200 2xl:flex-grow hide-scrollbar flex-grow">
			<div className="w-170px">
				...
				<button
					className={`text-[#AEAEAE] w-[170px] text-[16px] font-medium rounded-[5px] text-left ml-[-8px] p-2 mt-4 hover:text-white ${selectedButton === 'Overview' ? 'bg-[#232E3B] text-white' : ''}`}
					onClick={() => {
				...
				<br />
				<button
					className={`p-2 text-[#AEAEAE] text-[16px] font-medium pl-2 ml-[-8px] hover:text-white ${selectedButton === 'Permissions' ? 'bg-[#232E3B] text-white' : ''} mt-1 w-[170px] text-left rounded-[5px]`}
					onClick={() => {
				...
				<br />
				<button
					className={`p-2 text-[#AEAEAE] text-[16px] font-medium pl-2 ml-[-8px] hover:text-white ${selectedButton === 'Invites' ? 'bg-[#232E3B] text-white' : ''} mt-1 w-[170px] text-left rounded-[5px]`}
					onClick={() => {
				...
				<br />
				<button
					className={`p-2 text-[#AEAEAE] text-[16px] font-medium pl-2 ml-[-8px] hover:text-white ${selectedButton === 'Integrations' ? 'bg-[#232E3B] text-white' : ''} mt-1 w-[170px] text-left rounded-[5px]`}
					onClick={() => {
				...
				<button
					className={`p-2 text-[#AEAEAE] text-[16px] font-medium pl-2 ml-[-8px] hover:text-white ${selectedButton === 'Delete' ? 'bg-[#232E3B] text-white' : ''} w-[170px] text-left rounded-[5px]`}
					onClick={() => {
