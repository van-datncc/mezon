import communityMezonImg from 'libs/assets/src/assets/images/comunity_mezon_v2.png';
const EnableCommunity = ({ onEnable }: { onEnable: () => void }) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[400px] bg-[#5865F2] rounded-lg p-8">
            ...
            <button
                onClick={onEnable}
                className="px-8 py-3 bg-white text-[#5865F2] font-semibold rounded-lg shadow hover:bg-gray-100 transition"
            >
                Enable Community
            </button>
        </div>
