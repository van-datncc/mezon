...
import CanvasModalContent from './CanvasModalContent';
...
const CanvasItem = ({ thread, setIsShowThread }: CanvasItemProps) => {
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-row items-center h-6">
                        ...
                        <div className="overflow-hidden max-w-[140px]">
                            <CanvasModalContent message={message} thread={thread} />
                        </div>
