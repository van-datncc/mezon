...
const RenderContent = memo(({ data, mode, showOnchannelLayout, allChannelVoice, isOnlyContainEmoji }: RenderContentProps) => {
...
const MessageLine = ({ mode, content, showOnchannelLayout, onClickToMessage, isOnlyContainEmoji }: MessageLineProps) => {
