		...
		<div className="flex flex-col p-2 bg-[#FFFFFF] dark:bg-[#313338] rounded-lg ">
			{checkMessageHasReply && (
				<div className="max-w-full overflow-hidden">
					<MessageLine content={contentUpdatedMention} isJumMessageEnabled={false} isSingleLine={true} />
				</div>
			)}
			...
			<div className="flex flex-row p-1 w-full gap-4  rounded-lg bg-[#FFFFFF] dark:bg-[#313338]">
				...
				<div className="h-full">
					...
					<MessageLine content={contentUpdatedMention} isJumMessageEnabled={false} isSingleLine={false} />
