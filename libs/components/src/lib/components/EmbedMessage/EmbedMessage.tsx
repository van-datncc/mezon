...
export function EmbedMessage({ embed, message_id, senderId, onClick }: EmbedMessageProps) {
			...
			<div className="flex flex-col px-5 pt-2 pb-4">
				...
				<div className={'flex flex-row justify-between'}>
					<div className={`flex flex-col ${thumbnail && 'pr-2'}`}>
						...
						{fields && <EmbedFields fields={fields} message_id={message_id as string} senderId={senderId as string} />}
					</div>
