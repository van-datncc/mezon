...
export default function EmbedMessage({ embed, message_id, senderId }: { embed: IEmbedProps; message_id: string; senderId: string }) {
	...
	return (
		<div className="max-w-[520px] w-fit dark:bg-bgSecondary bg-white shadow-sm rounded-lg text-left relative mt-2 text-textLightTheme dark:text-textDarkTheme dark:border-none border">
