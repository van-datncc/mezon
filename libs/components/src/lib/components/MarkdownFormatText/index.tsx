...
const MarkdownFormatText = ({ mentions, isOnlyEmoji }: MarkdownFormatTextProps) => {
	...
	return (
		<article
			...
			prose-headings:my-0 prose-headings:contents
			prose-h1:prose-2xl whitespace-pre-wrap prose prose-base
			prose-blockquote:leading-[6px] prose-blockquote:my-0 ${appearanceTheme === 'light' ? 'lightMode' : ''}`}
		>
