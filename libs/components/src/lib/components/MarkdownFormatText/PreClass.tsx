...
const PreClass = ({ children, isInPinMsg }: IPreClassProps) => {
	...
	return (
		<pre
			className={`pre dark:text-white text-colorTextLightMode bg-bgLightSecondary dark:bg-bgSecondary border border-[#E3E5E8] dark:border-[#1E1F22] box-border ${isInPinMsg ? 'flex items-start' : ''}`}
		>
